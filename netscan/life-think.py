...
OLLAMA_MODEL = "qwen3.5-35b-a3b-iq2m"  # MoE: 64K-capable at 16 GiB (§3.3), for broad long-context synthesis
...
def call_ollama(system_prompt, user_prompt, temperature=0.3, max_tokens=4000, think=True):
    ...
    payload = json.dumps({
        ...
        "options": {
            ...
            "num_ctx": 32768,  # MoE handles this comfortably at 16 GiB (safe beside signal-cli)
        },
    }).encode()
